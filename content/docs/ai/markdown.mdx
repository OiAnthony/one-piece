...
See [all MDX components and available options](https://fumadocs.vercel.app/docs/ai/mdx).
...
See [Page Conventions](https://fumadocs.vercel.app/docs/ui/page-conventions#frontmatter) for a list of properties available for frontmatter.

## Codeblock

Syntax Highlighting is supported by default using [Rehype Code](https://fumadocs.vercel.app/docs/headless/mdx/rehype-code).
...
Not enabled by default. See [Twoslash](https://fumadocs.vercel.app/docs/ui/twoslash).
...
To enable, see [Math Integration](https://fumadocs.vercel.app/docs/ui/math).
...
To enable, see [Remark Install](https://fumadocs.vercel.app/docs/headless/mdx/install).

### More

You can see [a list of plugins](https://fumadocs.vercel.app/docs/headless/mdx) supported by Fumadocs.
