...
export const repo = process.env.NEXT_PUBLIC_GITHUB_REPO_NAME;
export const owner = process.env.NEXT_PUBLIC_GITHUB_REPO_OWNER;
export const DocsCategory = 'Docs Feedback';
export const githubRepoUrl = `https://github.com/${owner}/${repo}`;
...
async function getOctokit() {
  if (!owner || !repo) {
    console.warn('No GitHub repo provided, docs feedback feature will not work.');
    return;
  }
